...
class SessionForm(Form):
    ...
    select_platform = SelectField('select_platform', choices=[], id='select_platform')
    select_browser = SelectField('select_browser', choices=[], id='select_browser')
    select_version = SelectField('select_version', choices=[], id='select_version')
